      ...
      <div className="page--split">
        ...
        <section className="card">
          ...
          <p className="muted small">
            ...
            so this skill is not a rediscovery of “day 10 is worse than day 1”. The model
            is scored against climatology, lead-day and ensemble-spread baselines on
            exactly the same rows; that comparison is published with the code.
          </p>
        </section>
      </div>
